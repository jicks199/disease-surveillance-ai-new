...
const GenderDistributionCard = ({ male, female }) => (
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
    ...
    <div className="flex justify-between mt-2">
      ...
      <div className="text-center">
        <p className="text-2xl font-semibold text-pink-600">{female || "50%"}</p>
...
const AgeRatioCard = ({ ageRange, cases }) => (
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
    <div className="flex items-center">
      ...
      <div className="ml-4">
        <h3 className="text-sm font-medium text-gray-500">Dominant Age Group</h3>
        <p className="text-2xl font-semibold text-gray-900">{ageRange || "N/A"}</p>
